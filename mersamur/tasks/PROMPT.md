...
- NOL panggilan API live kecuali berkas tugas menyebut biaya kreditnya secara
  eksplisit. Kalau butuh data, pakai ../research/harness/recorded/ yang sudah
  dibayar 52 kredit dan berisi 23 rekaman live.
...
- Kode produk masuk ke mersamur/app/, state ke mersamur/state/. Jangan sentuh
  ../research/ kecuali berkas tugas menyebutnya — dosir riset dan harness itu
  bersama untuk seluruh repo, dan harness sengaja standard-library-only.
- Pengecualian: .github/workflows/ harus di root repo supaya GitHub Actions
  mengenalinya.
...
| # | Tugas (di `tasks/`) | Kredit | Kenapa di posisi ini |
| --- | --- | --- | --- |
