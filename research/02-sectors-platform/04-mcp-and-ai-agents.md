...
> at [`99-raw/sectors-mcp-repo-tree.txt`](../99-raw/sectors-mcp-repo-tree.txt).
...
> [`../99-raw/agent-skills/`](../99-raw/agent-skills/).
...
- **Develop against the mock.** [`../03-mock-data/`](../03-mock-data/) serves all 70 endpoints offline with a credit meter, so agent loops can run all day for zero credits.
