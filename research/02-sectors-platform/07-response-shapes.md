...
> OpenAPI spec. Full payloads are in [`../03-mock-data/fixtures/`](../03-mock-data/fixtures/)
...
- Fixture: [`v2_companies.json`](../03-mock-data/fixtures/v2_companies.json)

**`/v2/free-float/`** — Free Float Market Analysis

- Envelope: bare array
- Row keys: `symbol`, `company_name`, `free_float`
- Fixture: [`v2_free_float.json`](../03-mock-data/fixtures/v2_free_float.json)
...
- Fixture: [`v2_companies_list_companies_with_segments.json`](../03-mock-data/fixtures/v2_companies_list_companies_with_segments.json)
...
- Fixture: [`v2_companies_quarterly_financial_dates.json`](../03-mock-data/fixtures/v2_companies_quarterly_financial_dates.json)

**`/v2/company/get_quarterly_financial_dates/{symbol}/`** — Quarterly Financial Dates

- Envelope: object
- Top-level keys: `2026`
- Fixture: [`v2_company_get_quarterly_financial_dates_symbol.json`](../03-mock-data/fixtures/v2_company_get_quarterly_financial_dates_symbol.json)

**`/v2/industries/`** — Industries

- Envelope: bare array
- Row keys: `subsector`, `industry`
- Fixture: [`v2_industries.json`](../03-mock-data/fixtures/v2_industries.json)

**`/v2/subindustries/`** — Subindustries

- Envelope: bare array
- Row keys: `industry`, `sub_industry`
- Fixture: [`v2_subindustries.json`](../03-mock-data/fixtures/v2_subindustries.json)

**`/v2/subsectors/`** — Subsectors

- Envelope: bare array
- Row keys: `sector`, `subsector`
- Fixture: [`v2_subsectors.json`](../03-mock-data/fixtures/v2_subsectors.json)

**`/v2/tags/`** — News Tags

- Envelope: bare array
- Row keys: array of `str`
- Fixture: [`v2_tags.json`](../03-mock-data/fixtures/v2_tags.json)
...
- Fixture: [`v2_company_corporate_actions_symbol.json`](../03-mock-data/fixtures/v2_company_corporate_actions_symbol.json)
...
- Fixture: [`v2_company_get_segments_symbol.json`](../03-mock-data/fixtures/v2_company_get_segments_symbol.json)
...
- Fixture: [`v2_company_report.json`](../03-mock-data/fixtures/v2_company_report.json)
...
- Top-level keys: `symbol`, `company_name`, `overview`, `valuation`, `future`, `financials`, `dividend`, `management`, `ownership`, `peers`
- Row keys (inside `peers`): `peers_data`
- Fixture: [`v2_company_report_symbol.json`](../03-mock-data/fixtures/v2_company_report_symbol.json)
...
- Fixture: [`v2_company_shareholders_composition_symbol.json`](../03-mock-data/fixtures/v2_company_shareholders_composition_symbol.json)
...
- Fixture: [`v2_financials_quarterly_symbol.json`](../03-mock-data/fixtures/v2_financials_quarterly_symbol.json)
...
- Fixture: [`v2_subsector_report.json`](../03-mock-data/fixtures/v2_subsector_report.json)

**`/v2/subsector/report/{sub_sector}/`** — Subsector Report

- Envelope: object
- Top-level keys: `sector`, `sub_sector`, `statistics`, `market_cap`, `stability`, `valuation`, `growth`, `companies`
- Fixture: [`v2_subsector_report_sub_sector.json`](../03-mock-data/fixtures/v2_subsector_report_sub_sector.json)
...
- Fixture: [`v2_close.json`](../03-mock-data/fixtures/v2_close.json)

**`/v2/daily/{symbol}/`** — Daily Transaction Data

- Envelope: bare array
- Row keys: `symbol`, `date`, `close`, `open`, `high`, `low`, `volume`, `market_cap`
- Fixture: [`v2_daily_symbol.json`](../03-mock-data/fixtures/v2_daily_symbol.json)

**`/v2/idx-total/`** — IDX Market Summary

- Envelope: bare array
- Row keys: `date`, `idx_total_market_cap`
- Fixture: [`v2_idx_total.json`](../03-mock-data/fixtures/v2_idx_total.json)

**`/v2/index-daily/{index_code}/`** — Index Daily Transaction Data

- Envelope: bare array
- Row keys: `index_code`, `date`, `price`
- Fixture: [`v2_index_daily_index_code.json`](../03-mock-data/fixtures/v2_index_daily_index_code.json)
...
- Fixture: [`v2_companies_top_changes.json`](../03-mock-data/fixtures/v2_companies_top_changes.json)
...
- Fixture: [`v2_most_traded.json`](../03-mock-data/fixtures/v2_most_traded.json)
...
- Fixture: [`v2_listing_performance_symbol.json`](../03-mock-data/fixtures/v2_listing_performance_symbol.json)
...
- Fixture: [`v2_filings.json`](../03-mock-data/fixtures/v2_filings.json)
...
- Fixture: [`v2_news.json`](../03-mock-data/fixtures/v2_news.json)
...
- Fixture: [`v2_suspensions.json`](../03-mock-data/fixtures/v2_suspensions.json)
...
- Fixture: [`v2_broker_activity_broker_code.json`](../03-mock-data/fixtures/v2_broker_activity_broker_code.json)
...
- Fixture: [`v2_broker_activity_broker_code_top.json`](../03-mock-data/fixtures/v2_broker_activity_broker_code_top.json)
...
- Row keys (inside `data`): `date`, `summary`
- Fixture: [`v2_broker_summary_symbol.json`](../03-mock-data/fixtures/v2_broker_summary_symbol.json)
...
- Fixture: [`v2_broker_summary_symbol_top.json`](../03-mock-data/fixtures/v2_broker_summary_symbol_top.json)

**`/v2/brokers/`** — Broker Registry

- Envelope: bare array
- Row keys: `code`, `name`, `is_foreign`, `cohort`, `license_type`
- Fixture: [`v2_brokers.json`](../03-mock-data/fixtures/v2_brokers.json)
...
- Fixture: [`v2_brokers_top.json`](../03-mock-data/fixtures/v2_brokers_top.json)
...
- Fixture: [`v2_foreign_flow_symbol.json`](../03-mock-data/fixtures/v2_foreign_flow_symbol.json)
...
- Top-level keys: `results`, `pagination`, `llm_translation`
- Row keys (inside `results`): `symbol`, `company_name`, `query_values`
- Fixture: [`v2_sgx_companies.json`](../03-mock-data/fixtures/v2_sgx_companies.json)
...
- Envelope: bare array
- Row keys: array of `str`
- Fixture: [`v2_sgx_sectors.json`](../03-mock-data/fixtures/v2_sgx_sectors.json)

**`/v2/sgx/subsectors/`** — SGX Subsectors

- Envelope: bare array
- Row keys: `sector`, `subsector`
- Fixture: [`v2_sgx_subsectors.json`](../03-mock-data/fixtures/v2_sgx_subsectors.json)

**`/v2/sgx/tags/`** — SGX News Tags

- Envelope: object
- Top-level keys: `tags`
- Fixture: [`v2_sgx_tags.json`](../03-mock-data/fixtures/v2_sgx_tags.json)
...
- Fixture: [`v2_sgx_company_report.json`](../03-mock-data/fixtures/v2_sgx_company_report.json)

**`/v2/sgx/company/report/{symbol}/`** — Full company report for an SGX-listed symbol

- Envelope: object
- Top-level keys: `symbol`, `name`, `overview`, `valuation`, `financials`, `dividend`
- Fixture: [`v2_sgx_company_report_symbol.json`](../03-mock-data/fixtures/v2_sgx_company_report_symbol.json)
...
- Fixture: [`v2_sgx_buybacks.json`](../03-mock-data/fixtures/v2_sgx_buybacks.json)

**`/v2/sgx/daily/{symbol}/`** — SGX Daily Price Data

- Envelope: bare array
- Row keys: `symbol`, `date`, `close`, `open`, `high`, `low`, `volume`
- Fixture: [`v2_sgx_daily_symbol.json`](../03-mock-data/fixtures/v2_sgx_daily_symbol.json)
...
- Fixture: [`v2_sgx_short_sell.json`](../03-mock-data/fixtures/v2_sgx_short_sell.json)
...
- Fixture: [`v2_sgx_companies_top.json`](../03-mock-data/fixtures/v2_sgx_companies_top.json)
...
- Fixture: [`v2_sgx_filings.json`](../03-mock-data/fixtures/v2_sgx_filings.json)
...
- Fixture: [`v2_sgx_news.json`](../03-mock-data/fixtures/v2_sgx_news.json)
...
- Fixture: [`v2_klse_companies.json`](../03-mock-data/fixtures/v2_klse_companies.json)
...
- Fixture: [`v2_klse_companies_top.json`](../03-mock-data/fixtures/v2_klse_companies_top.json)

**`/v2/klse/company/report/`** — Full company report for a KLSE-listed symbol

- Envelope: object
- Top-level keys: `symbol`, `name`, `overview`, `valuation`, `financials`, `dividend`
- Fixture: [`v2_klse_company_report.json`](../03-mock-data/fixtures/v2_klse_company_report.json)

**`/v2/klse/company/report/{symbol}/`** — Full company report for a KLSE-listed symbol

- Envelope: object
- Top-level keys: `symbol`, `name`, `overview`, `valuation`, `financials`, `dividend`
- Fixture: [`v2_klse_company_report_symbol.json`](../03-mock-data/fixtures/v2_klse_company_report_symbol.json)

**`/v2/klse/sectors/`** — List all KLSE sectors

- Envelope: bare array
- Row keys: array of `str`
- Fixture: [`v2_klse_sectors.json`](../03-mock-data/fixtures/v2_klse_sectors.json)
...
- Fixture: [`v2_mining_companies.json`](../03-mock-data/fixtures/v2_mining_companies.json)

**`/v2/mining/companies/financials/{slug}/`** — Mining Company Financials

- Envelope: object
- Top-level keys: `year`, `available_years`, `data`
- Fixture: [`v2_mining_companies_financials_slug.json`](../03-mock-data/fixtures/v2_mining_companies_financials_slug.json)
...
- Fixture: [`v2_mining_companies_ownership_slug.json`](../03-mock-data/fixtures/v2_mining_companies_ownership_slug.json)
...
- Fixture: [`v2_mining_companies_performance_slug.json`](../03-mock-data/fixtures/v2_mining_companies_performance_slug.json)
...
- Fixture: [`v2_mining_companies_slug.json`](../03-mock-data/fixtures/v2_mining_companies_slug.json)
...
- Fixture: [`v2_mining_commodities.json`](../03-mock-data/fixtures/v2_mining_commodities.json)

**`/v2/mining/commodities/{commodity_name}/price/`** — Commodity Price History

- Envelope: bare array
- Row keys: `name`, `date`, `price_usd_per_ton`
- Fixture: [`v2_mining_commodities_commodity_name_price.json`](../03-mock-data/fixtures/v2_mining_commodities_commodity_name_price.json)

**`/v2/mining/exports/`** — Top Export Destinations

- Envelope: bare array
- Row keys: `country`, `export_usd`, `export_volume_bps`, `export_volume_esdm`, `volume_unit`
- Fixture: [`v2_mining_exports.json`](../03-mock-data/fixtures/v2_mining_exports.json)
...
- Fixture: [`v2_mining_global_commodity.json`](../03-mock-data/fixtures/v2_mining_global_commodity.json)

**`/v2/mining/sales-destination/{slug}/`** — Company Sales Destinations

- Envelope: object
- Top-level keys: `year`, `data`
- Fixture: [`v2_mining_sales_destination_slug.json`](../03-mock-data/fixtures/v2_mining_sales_destination_slug.json)
...
- Envelope: object
- Top-level keys: `Aceh`
- Fixture: [`v2_mining_resources_reserves.json`](../03-mock-data/fixtures/v2_mining_resources_reserves.json)

**`/v2/mining/resources-reserves/{province}/`** — Resources & Reserves Detail

- Envelope: object
- Top-level keys: `province`, `data`
- Fixture: [`v2_mining_resources_reserves_province.json`](../03-mock-data/fixtures/v2_mining_resources_reserves_province.json)
...
- Fixture: [`v2_mining_sites.json`](../03-mock-data/fixtures/v2_mining_sites.json)
...
- Fixture: [`v2_mining_sites_slug.json`](../03-mock-data/fixtures/v2_mining_sites_slug.json)
...
- Fixture: [`v2_mining_total_production.json`](../03-mock-data/fixtures/v2_mining_total_production.json)
...
- Fixture: [`v2_mining_contracts.json`](../03-mock-data/fixtures/v2_mining_contracts.json)
...
- Fixture: [`v2_mining_license_auctions.json`](../03-mock-data/fixtures/v2_mining_license_auctions.json)
...
- Fixture: [`v2_mining_license_auctions_wiup_code.json`](../03-mock-data/fixtures/v2_mining_license_auctions_wiup_code.json)
...
- Fixture: [`v2_mining_licenses.json`](../03-mock-data/fixtures/v2_mining_licenses.json)
