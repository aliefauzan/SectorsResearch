...
credit, so nothing here is invented.
    ...
    python3 plan_live.py                 # writes plan-live.json from recorded/
    python3 capture.py --plan plan-live.json --budget 60
...
def build():
    ...
    with open(os.path.join(HERE, "fixtures", "_index.json")) as fh:
...
if __name__ == "__main__":
    ...
    out = os.path.join(HERE, "plan-live.json")
