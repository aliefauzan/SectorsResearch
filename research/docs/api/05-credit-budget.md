...
[`harness/`](../../harness/) serves every one of the 70 endpoints offline from the
...
> the only independent check. Evidence: [`audit/VERIFICATION-LIVE.md`](../../audit/VERIFICATION-LIVE.md).
...
[mock server and synthetic datasets](../../harness/) from day one, and treat the live API as
