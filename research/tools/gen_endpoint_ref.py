...
spec = json.load(open('evidence/spec/schema.json'))
paths = spec['paths']
...
W("> (`info.version` = 2.0.0). Raw copy kept at [`evidence/spec/schema.json`](../../evidence/spec/schema.json).")
W("")
...
open('docs/api/02-endpoint-reference.md','w').write("\n".join(lines) + "\n")
