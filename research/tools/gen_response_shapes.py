...
OUT = "docs/api/07-response-shapes.md"
...
def main():
    ...
    W("> OpenAPI spec. Full payloads are in [`harness/fixtures/`](../../harness/fixtures/)")
    ...
    for group, tags in GROUPS:
        ...
        for tag in tags:
            ...
            for path, meta in sorted(items):
                ...
                W(f"- Fixture: [`{meta['fixture']}`](../../harness/fixtures/{meta['fixture']})")
                W("")
    open(OUT, "w").write("\n".join(lines) + "\n")
